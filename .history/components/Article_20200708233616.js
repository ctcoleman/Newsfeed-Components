...
data.forEach(object => {
  let article = articleMaker({title: object.title, date: object.date, firstParagraph: object.firstParagraph, secondParagraph: object.secondParagraph, thirdParagraph})
