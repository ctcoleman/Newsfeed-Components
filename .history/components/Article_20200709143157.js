...
data.forEach(object => {
  let article = articleMaker({ title, date: object.date, firstParagraph: object.firstParagraph, secondParagraph: object.secondParagraph, thirdParagraph: object.thirdParagraph })
